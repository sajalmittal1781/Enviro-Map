...
//             try {
//                 const response = await axios.get('http://localhost:4000/cities'); // Update the URL with your server's endpoint
...
//                 // Check if the newData is different from the current data before updating
...
//         // Set up automatic reloading at a specified interval (e.g., every 10 minutes)
        ...
        <div className="min-h-screen flex flex-col bg-gray-100">
            <header className="bg-gray-600 text-white p-4 flex justify-between items-center">
                ...
                <div className="flex items-center">
                    ...
                    {/* Add more navigation items or user-related information here */}
                </div>
            </header>
            <div className="flex-grow p-4">
                <div style={{ height: '85vh', width: '100%' }}>
